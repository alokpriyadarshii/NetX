...
// The DoH core. Owns the per-request lifecycle (allocate state on
...
// Optional callback invoked the first time the service is ready to serve
...
// Mark the service as awaiting bootstrap. Until the first successful resolver
